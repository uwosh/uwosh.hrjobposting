...
def setup_product():
    ...
    import uwosh.hrjobposting
    zcml.load_config('configure.zcml', uwosh.hrjobposting)
    ...
    ztc.installPackage('uwosh.hrjobposting')
...
setup_product()
ptc.setupPloneSite(products=['uwosh.hrjobposting'])
